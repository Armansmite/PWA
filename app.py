...
# In‑memory storage (will reset if the service restarts, which is fine for a single‑user tool)
settings_data = {
    "total_duration": 7,
    "fade_duration": 2,
    "max_quote_len": 50,
...
# ---------- STUB AUTH ROUTES (not used by Colab worker) ----------
...
# ---------- DASHBOARD HTML (the same glassmorphism UI you love) ----------
DASHBOARD_HTML = r"""
<!DOCTYPE html>
<html lang="en">
<head>
