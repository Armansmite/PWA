...
last_heartbeat = 0
processing_command = False          # Set to True when user clicks "Start"
...
# --- The HTML (update the Run tab as described above) ---
# I'll provide the full updated HTML snippet for the Run tab; the rest is the same.
# For brevity, I'll show only the changed part of the HTML. You'll need to merge it into the full HTML string.
