...
BOT_USER_ID = os.environ.get("BOT_USER_ID")        # set this after creating your account
...
def get_user_id_for_request():
    """Return user_id if request is authenticated, or BOT_USER_ID if secret header is valid."""
    # Bot worker?
